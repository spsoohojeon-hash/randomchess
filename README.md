...
전체능력묶음 또는 선택능력묶음을 고를 수 있습니다. 선택능력묶음은 체크한 능력 안에서만 무작위 배정합니다. 한 개만 선택하면 양쪽에 같은 능력을 배정하고, 둘 이상이면 서로 다른 능력을 배정합니다. 로컬 대국에서는 양쪽 능력을 볼 수 있고, 온라인 대국에서는 자신의 능력만 확인할 수 있습니다.
