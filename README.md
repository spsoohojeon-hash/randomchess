...
기본 8종 또는 전체 17종을 고를 수 있습니다. 로컬 대국에서는 양쪽 능력을 볼 수 있고, 온라인 대국에서는 자신의 능력만 확인할 수 있습니다.
능력을 무작위로 뽑으면 서로 다른 능력이 배정됩니다. 자세한 판정은 게임 안의 능력 도감에 있습니다.

기본 8종: 네크로맨서, 존나 야생마, 우주여행, 더블무브, 평등국가, 반동분자, 퇴마(물리), 왕의 귀환.
추가 9종: 폭탄 발사대, 그 수 하지 마, 테무산 타임스톤, 극한의 효율, 속전속결, 이 국가는 여왕이 통치한다, 다재다능, 5수 앞, 양심테스트.
