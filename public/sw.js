...
self.addEventListener('fetch',event=>{
  ...
  if(req.method!=='GET'||url.origin!==self.location.origin||url.pathname.startsWith('/api/')||url.pathname.startsWith('/research')||url.pathname.includes('chatgpt')||url.pathname==='/callback')return;
