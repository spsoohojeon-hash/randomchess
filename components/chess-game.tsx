...
export default function ChessGame(){
  ...
  const ammoSides=(["w","b"] as Side[]).filter(s=>active&&(!online||s===mySide)&&game.abilities[s].id==="gatling");
  const hiddenPieces=(["w","b"] as Side[]).flatMap(s=>(!online||s===mySide)&&game.abilities[s].burrow?[game.abilities[s].burrow!]:[]);
